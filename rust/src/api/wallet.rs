...
fn legacy_err<T>() -> Result<T> {
    Err(anyhow::anyhow!(
        "Legacy zingolib engine has been removed. Use the new engine."
    ))
}
...
pub async fn get_wallet_synced_height() -> Result<u32> {
    legacy_err()
}
...
pub async fn create_account() -> Result<u32> {
    legacy_err()
}
pub async fn get_account_count() -> Result<u32> {
    legacy_err()
}
#[allow(unused_variables)]
pub async fn get_account_balance(account_index: u32) -> Result<WalletBalance> {
    legacy_err()
}
#[allow(unused_variables)]
...
#[allow(unused_variables)]
pub async fn shield_account(account_index: u32) -> Result<String> {
    legacy_err()
}
#[allow(unused_variables)]
...
#[allow(unused_variables)]
pub fn parse_payment_uri(uri: String) -> Result<Vec<PaymentRecipient>> {
    legacy_err()
}
#[allow(unused_variables)]
pub fn build_payment_uri(address: String, amount: u64, memo: Option<String>) -> Result<String> {
    legacy_err()
}
#[allow(unused_variables)]
...
#[allow(unused_variables)]
pub async fn get_latest_block_height(server_url: String, chain_type: ChainType) -> Result<u32> {
    legacy_err()
}
